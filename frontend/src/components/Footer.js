...
const Footer = () => {
  return (
    <footer className="text-gray-600 body-font  w-100 h-100 bottom-0 fixed">
  ...
  <div className="container px-5  mx-auto flex items-center sm:flex-row flex-col">
    ...
    <span className="inline-flex  right-0 fixed mr-9   sm:mt-0 mt-4 justify-end sm:justify-end">
